...
const debug = Debug('regraf:session-local')
 ...
 * @param {String} [options.property] - Name of property in Regraf Context where session object will be located `default:` `'session'`
 ...
 * @param {Function} [options.getSessionKey] - Function to get identifier for session from Regraf Context (may implement it on your own)
...
class LocalSession {
  ...
  /**
   * Get session key from Regraf Context
   *
   * @param {Object} ctx - Regraf Context
  ...
  /**
   * Session middleware for use in Regraf
   *
   * @param {String} [property] - Name of property in Regraf Context where session object will be located (overrides `property` at {@link LocalSession} constructor)
   * @returns {Promise}
   */
  middleware (property = this.options.property) {
    ...
    return async (ctx, next) => {
      ...
      // Assigning session object to the Regraf Context using `property` as a variable name
      Object.defineProperty(ctx, property, {
        get: function () { return session },
        set: function (newValue) { session = Object.assign({}, newValue) }
      })
      // Make lowdb available in the Regraf Context
...
/**
 * @overview {@link https://github.com/regraf-bots/regraf|Regraf} Session middleware for storing sessions locally (Memory/FileSync/FileAsync/...)
 * @module @regraf/session-local
 * @license MIT
 * @author Tema Smirnov <git.tema@smirnov.one>
 * @requires {@link https://www.npmjs.com/package/regraf|npm: regraf}
 * @requires {@link https://www.npmjs.com/package/lowdb|npm: lowdb}
 * @see {@link https://github.com/regraf-bots/regraf|Regraf} | {@link https://github.com/typicode/lowdb|lowdb}
